...
.social li { float: right; size: 28px; }
...
?>
   ...
   <h2 align="left">Your favourite branch</h2><br />
...
<div style="width: 30px; float:left; height:30px; background:transparent; margin:10px">
